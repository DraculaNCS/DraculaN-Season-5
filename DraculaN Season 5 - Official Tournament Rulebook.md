**DraculaN Season 5 \- Official Tournament Rulebook**
...
DraculaN is a Tier 2 Valve Regional Standings (VRS) ranked Counter-Strike 2 tournament with an open LAN format. This event provides a grassroots competitive experience in the heart of Bucharest, welcoming any team ready to compete.

As a VRS-ranked event, DraculaN adheres to Valve’s rules for ranked tournaments, ensuring a fair structure for invites and qualifiers. The Valve Regional Standings (VRS) is the official ranking system used by Valve to gauge team performance and determine invitations for CS2 events.

This rulebook outlines all regulations, format details, and expectations for teams participating in DraculaN.

### **Event Information**

**Event Name:** DraculaN Season 5 \- Counter-Strike 2 Open LAN

**Time Zone:** All times listed in this rulebook follow Bucharest local time (EET/EEST).
...
Teams must register via [www.draculan.gg](http://www.draculan.gg).  
A registration fee of **€1,000 \+ VAT** per team (covers 5 players \+ 1 coach) is required to confirm entry.  
Registration is first-come, first-served.  
Sign-ups close automatically on February 10, 2026 at 23:59 (Bucharest time).
...
Teams register on the official website. Payment of **€1,000 \+ VAT** per team (covers 5 players \+ 1 coach) secures the spot. After payment, the team representative will receive the registration form via the official DraculaN Discord server, which must be completed to confirm participation.

### **Roster Rules:**

Teams may register up to 5 players and 1 coach. The roster is locked fourteen days before the event. After this date teams must retain their registered core (3 out of the 5 initially registered players).

### **VRS Seeding:**

In line with Valve’s guidelines for Tier 2 events, **DraculaN Season 5** will use VRS rankings to seed teams into the Main Event. Once registration closes (approximately two weeks before the event), the top 8 teams by VRS rank among the registered teams will be seeded directly into the Main Event bracket.
...
Teams must check in at the venue on Day 1 by the designated time (exact schedule to be provided and available on the [www.draculan.gg](http://www.draculan.gg) website). All team members should be on-site and ready at least one hour before their first match. Any team that fails to check in on time may be disqualified.
...
DraculaN Season 5 spans five days, featuring a GSL-style group stage and a double-elimination playoff bracket. With 24 teams signed up by the registration cutoff date, the format is structured as follows:

**Day 1 \- Group Stage:**  
16 teams compete in 4 GSL groups of 4 teams each. Group winners and runners-up advance to the Playoffs.

**Days 2-5 \- Playoffs:**  
A 16-team double-elimination bracket begins, combining the 8 advancing teams from the Group Stage with the 8 highest VRS-ranked teams directly seeded into the Playoffs.
...
Each group will contain exactly one team from each pot. The live draw will be held on February  11 and broadcast on the official DraculaN Kick.com channel: [https://kick.com/draculancs](https://kick.com/draculancs).
...
Short breaks (5-10 minutes) will be provided between back-to-back matches, but teams must be prepared for quick transitions, especially in Decider Matches.
...
The 8 VRS-seeded teams and the 8 Group Stage qualifier teams are paired in the Opening Playoff Round (BO1) as follows:

| Match \# | VRS-Seeded Team | Group Stage Position |
| ----- | ----- | ----- |
| Match 1 | VRS \#1 | 4th Ranked Group Stage Runner-up |
| Match 2 | VRS \#8 | 1st Ranked Group Stage Winner |
| Match 3 | VRS \#4 | 1st Ranked Group Stage Runner-up |
| Match 4 | VRS \#5 | 4th Ranked Group Stage Winner |
| Match 5 | VRS \#6 | 3rd Ranked Group Stage Winner |
| Match 6 | VRS \#3 | 2nd Ranked Group Stage Runner-up |
| Match 7 | VRS \#7 | 2nd Ranked Group Stage Winner |
| Match 8 | VRS \#2 | 3rd Ranked Group Stage Runner-up |
...
The higher-seeded team chooses either:  
a) map veto order, or  
b) starting side.
...
In every match (Group Stage and Playoffs), the higher-seeded team is the team that belongs to a higher value pot and always has priority to choose either:  
 a) map veto order, or  
 b) starting side.
...
The DraculaN Season 5 tournament prize pool is fully crowdfunded by team registration fees. There is no base prize pool funded by the organizer. The total prize pool depends on the number of participating teams, with a maximum cap of 24 teams.

Each team pays a registration fee of **€1,000 \+ VAT**.

### **Prize Pool by Team Count**

* **8 or more teams:** $5,000 total prize pool

* **16 teams:** $10,000 total prize pool
...
In the unlikely event that **DraculaN Season 5** is postponed or canceled due to unforeseen circumstances (including but not limited to natural disasters, venue failure, national emergencies, or health crises), the organizers will:  
...
This rulebook is designed to ensure that **DraculaN Season 5** runs smoothly, competitively, and fairly for all participants. All teams and players are expected to read, understand, and comply with these rules. The organizing staff will be available throughout the event to answer questions or provide clarifications as needed.

**IMPORTANT:**  
The event organizers reserve the right to amend or modify this rulebook at any time. All changes will be published publicly with updates to this document and will be made available to all participants through the Draculan.gg website and the official DraculaN Discord server.
...
Let’s make this a memorable event for everyone: players, viewers, and staff alike. Good luck and have fun to all teams, and welcome to **DraculaN Season 5**.
